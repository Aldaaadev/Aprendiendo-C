...
int main (){
	...
	cout<<"\n\n";
	cout<<"\tProyecto NO.2"<<endl;
	cout<<"Hecho con <3 por: "<<endl;
	cout<<"1. Aldair Tercero 8-954-1392"<<endl;
	cout<<"2. Carlos Wittgreen 8-1001-1540"<<endl;
	cout<<"3. Alexander Mela 8-1007-984"<<endl;
	cout<<"4. Cesar Garcia 8-981-1484"<<endl;
